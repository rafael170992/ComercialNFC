...
namespace ComercialNFC
{
    class MgwServicios
    {
        ...
        #region ESTRUCTURA SERIES CAPAS
        ...
        [DllImport("MGWServicios.DLL")]
        public static extern int fLeeDatoAgente(string aCampo, string aValor, int aLen);
        ...
        [DllImport("MGWServicios.dll")]
        public static extern int fTimbraXML(string aRutaXML, string aCodConcepto, StringBuilder aUUID, string aRutaDDA,
        ...
        //public static extern int fLeeDatoDocumento(string aCampo, string aValor, int aLen);
